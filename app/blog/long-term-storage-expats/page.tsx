...
export const metadata: Metadata = {
  ...
  description: "Complete guide to long-term storage in Dubai for expats. How it works, pricing from 12.60 AED / sqft, managing your storage remotely, and when long-term storage makes sense vs other options.",
        ...
        <article className="py-12">
          <div className="container px-4 max-w-4xl mx-auto prose prose-lg max-w-none text-gray-700">
            ...
            <div className="space-y-4 mb-8">
              {[
                { scenario: "You're not sure you're coming back", desc: "88% of expats who leave Dubai say they'd consider returning. If there's a 30%+ chance you'll be back within 2 years, storage often beats shipping. With pricing from 12.60 AED / sqft (VAT-inclusive), storing a unit long-term costs far less than one-way shipping — and a fraction of shipping both ways." },
