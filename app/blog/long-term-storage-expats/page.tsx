        ...
        <article className="py-12">
          <div className="container px-4 max-w-4xl mx-auto prose prose-lg max-w-none text-gray-700">
            ...
            <div className="bg-dubai-gold/10 border border-dubai-gold/30 rounded-xl p-6 mb-6">
              <p className="text-dubai-navy font-medium"><strong>Get a free, itemised quote for long-term storage.</strong> Whether you store for 3 months over summer or 2 years on secondment, you pay the same straightforward per-square-foot rate for the space you reserve.</p>
            </div>
            ...
            <div className="overflow-x-auto mb-8">
              <table className="w-full border-collapse rounded-xl overflow-hidden">
                ...
                <tbody>
                  {[
                    ["Total cost", "Only the space you use — free, itemised quote", "AED 35,000–60,000 (both ways)"],
