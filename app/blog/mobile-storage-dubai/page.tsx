...
export const metadata: Metadata = {
  title: { absolute: "Mobile Storage Dubai — Door-to-Door Service Storage" },
  description: "Mobile storage in Dubai — we come to you, pick up your belongings, store them safely, and deliver back when you're ready. Door-to-Door pickup across Dubai.",
  ...
  openGraph: {
    ...
    description: "Mobile storage with door-to-door pickup across Dubai. We come to you, collect your items, store them safely, and deliver back. No hassle, no transport needed.",
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white">
        ...
        <article className="py-12">
          <div className="container px-4 max-w-4xl mx-auto prose prose-lg max-w-none text-gray-700">
            ...
            <div className="bg-dubai-navy text-white rounded-2xl p-8 text-center">
              <h2 className="text-2xl font-bold mb-3">Book Your Door-to-door Pickup Today</h2>
              <p className="text-white/80 mb-6">Available 7 days a week across all Dubai areas. Door-to-Door pickup, professional wrapping, secure storage.</p>
              <div className="flex flex-wrap gap-4 justify-center">
                <Link href="https://safestorage.ae/get-quote">
                  <Button className="bg-dubai-gold hover:bg-dubai-darkgold text-white px-8 py-3 text-lg">Book Door-to-door Pickup</Button>
                </Link>
        ...
        <RelatedGuides currentSlug="mobile-storage-dubai" />
      </div>
    </>
  )
}
