  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white">
        ...
        <article className="py-12">
          <div className="container px-4 max-w-4xl mx-auto prose prose-lg max-w-none text-gray-700">
            ...
            <div className="bg-dubai-navy text-white rounded-2xl p-8 text-center mt-10">
              ...
              <p className="text-white/80 mb-6">Our team provides door-to-door pickup with professional wrapping and packing assistance. We bring materials and ensure everything is stored safely.</p>
        ...
        <RelatedGuides currentSlug="packing-tips-dubai" />
      </div>
    </>
  )
}
