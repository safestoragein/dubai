            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <div className="bg-green-50 border border-green-200 rounded-xl p-5">
                ...
                <div className="space-y-2 text-sm text-green-700">
                  <div className="flex justify-between"><span>Unit pricing</span><span className="font-bold">From 12 AED / sqft</span></div>
                  <div className="flex justify-between"><span>Door-to-Door pickup + delivery</span><span className="font-bold">AED 0</span></div>
                  <div className="border-t border-green-300 pt-2 flex justify-between font-bold"><span>Total</span><span>From 12 AED / sqft</span></div>
                </div>
              </div>
