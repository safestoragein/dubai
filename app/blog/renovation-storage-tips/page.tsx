  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white">
        ...
        <article className="py-12">
          <div className="container px-4 max-w-4xl mx-auto prose prose-lg max-w-none text-gray-700">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <div className="bg-green-50 border border-green-200 rounded-xl p-5">
                ...
                <div className="space-y-2 text-sm text-green-700">
                  <div className="flex justify-between"><span>Unit pricing</span><span className="font-bold">Only the space you use</span></div>
                  <div className="flex justify-between"><span>Door-to-Door pickup + delivery</span><span className="font-bold">Included</span></div>
                  <div className="border-t border-green-300 pt-2 flex justify-between font-bold"><span>Total</span><span>Free, itemised quote</span></div>
                </div>
              </div>
            ...
            <div className="bg-dubai-navy text-white rounded-2xl p-8 text-center">
              ...
              <p className="text-white/80 mb-6">Book your storage before your contractors start. Door-to-Door pickup across all Dubai areas — we make renovation storage simple.</p>
        ...
        <RelatedGuides currentSlug="renovation-storage-tips" />
      </div>
    </>
  )
}
