          ...
          <div className="container px-4 max-w-4xl mx-auto prose prose-lg max-w-none text-gray-700">
            ...
            <div className="space-y-6 mb-8">
              {[
                ...
                { option: "Option 3: Store with SafeStorage Dubai", cost: "You only pay for the space you use", pros: ["Clean, secure, indoor units", "Door-to-Door pickup", "Security monitored 24/7", "Pay only for what you store", "Peace of mind abroad"], cons: ["Requires move-out and move-in effort", "Monthly storage cost"] },
              ].map((opt) => (
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-6 mb-8">
              <div className="space-y-3">
                {[
                  { item: "Medium storage unit", cost: "Only the space you use" },
                  { item: "Door-to-Door pickup + delivery (SafeStorage)", cost: "Included" },
                  { item: "Total storage cost", cost: "Free, itemised quote" },
                  { item: "", cost: "" },
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              {[
                ...
                { name: "Vikram S.", location: "JVC", text: "Leaving for 3 months, didn't want to keep paying AED 1,500 electricity for an empty flat. I put everything into storage and switched off the AC entirely. Came back to a working home and AED 2,700 saved on electricity alone." },
              ].map((t) => (
