...
const schemas = [
  ...
  },
  {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Document Storage Dubai", item: "https://safestorage.ae/business-storage-dubai/document-storage" },
    ],
  },
]
...
export default function DocumentStoragePage() {
  return (
    <>
        ...
        <section className="bg-gradient-to-r from-dubai-navy to-dubai-blue text-white py-20">
          <div className="container px-4 max-w-6xl mx-auto">
            <div className="max-w-3xl">
              ...
              <p className="text-xl text-white/85 mb-8">Free up prime office space and comply with UAE retention requirements — without destroying documents you're legally required to keep. SafeStorage Dubai provides secure, access-controlled document and archive storage for businesses and individuals from 12 AED / sqft.</p>
      ...
      <SiloLinks path="/business-storage-dubai/document-storage" />
    </>
  )
}
