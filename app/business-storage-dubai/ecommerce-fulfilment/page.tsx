...
const schemas = [
  ...
  },
  {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "E-Commerce Storage Dubai", item: "https://safestorage.ae/business-storage-dubai/ecommerce-fulfilment" },
    ],
  },
]
...
const comparison = [
  ...
  { aspect: "Monthly cost", storage: "From 12 AED / sqft", warehouse: "AED 5,000–15,000+" },
        ...
        <section className="bg-gradient-to-r from-dubai-navy to-dubai-blue text-white py-20">
          <div className="container px-4 max-w-6xl mx-auto">
            <div className="max-w-3xl">
              ...
              <p className="text-xl text-white/85 mb-8">Growing your Dubai e-commerce business shouldn't mean committing to a 3-year warehouse lease. SafeStorage Dubai provides flexible monthly inventory storage — scale up or down as your business demands. From 12 AED / sqft with no long-term commitment.</p>
