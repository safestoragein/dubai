...
export const metadata: Metadata = {
  ...
  description: "Store your car, motorcycle, boat or classic vehicle safely in Dubai. Climate-controlled 20-25°C, 24/7 CCTV, free insurance up to AED 5,000. Vehicle storage from 12.65 AED / sqft. Hassle-free pickup. Call +971505773388.",
  ...
  openGraph: {
    ...
    description: "Protect your car, motorcycle, or classic vehicle from Dubai's 50°C summer heat. Secure climate-controlled storage from 12.65 AED / sqft with hassle-free pickup.",
...
const schemas = [
  {
    ...
    description: "Climate-controlled vehicle storage in Dubai for cars, motorcycles, boats and classic vehicles. 24/7 security, free insurance, from 12.65 AED / sqft.",
    provider: { "@id": "https://safestorage.ae/#organization" },
    url: "https://safestorage.ae/car-storage",
    areaServed: { "@type": "City", name: "Dubai" },
    serviceType: "Vehicle Storage",
    offers: { "@type": "Offer", price: "12.65", priceCurrency: "AED", availability: "https://schema.org/InStock" },
  },
  {
    "@context": "https://schema.org",
    "@type": "WebPage",
