                  ...
                  <div className="mt-8 grid md:grid-cols-2 gap-6 items-center bg-gradient-to-r from-[#0A2463]/5 to-[#3E92CC]/5 p-6 rounded-xl border border-[#3E92CC]/20">
                    <div>
                      ...
                      <p className="text-gray-700 mb-4 text-sm leading-relaxed">
                        {index === 0 ? "Paying AED 90,000/year for a 2-bed apartment? Get a 1-bed for AED 60,000 and store extra items from just 12 AED / sqft. Save thousands annually!" :
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              ...
              <div className="bg-white/10 backdrop-blur-sm p-6 rounded-lg">
                ...
                <h3 className="font-semibold mb-2">Storage from 12 AED / sqft</h3>
