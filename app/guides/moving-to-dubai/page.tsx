...
const sections = [
  ...
  },
  {
    ...
    storageConnection: "Save money on rent! Instead of paying for a bigger apartment, store seasonal items, sports gear, and rarely-used belongings. Storage from 12 AED / sqft beats paying AED 3,000+ extra rent annually for a bigger place.",
