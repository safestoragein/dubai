                    ...
                    <div className="flex flex-col gap-6 md:flex-row md:items-center">
                      <div className="flex-1">
                        ...
                        {step.step === 5 ? (
                          ...
                          <p className="text-gray-700">
                            <strong>Secure document storage from day 1.</strong> Store licenses, contracts, invoices, and legal documents safely. UAE law requires keeping business records for 5 years. Clean, secure facility with 24/7 access, and you pay only for the space you use.
                          </p>
                        )}
                      </div>
            ...
            <div className="flex flex-col gap-6 md:flex-row md:items-center">
              <div className="flex-1">
                ...
                <ul className="space-y-3">
                  ...
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="mt-1 h-6 w-6 flex-shrink-0" />
                    <span><strong>Document archival:</strong> Secure 5-year record keeping, paying only for the space you use</span>
                  </li>
                </ul>
                <div className="mt-6">
          ...
          <div className="mx-auto max-w-4xl space-y-6 mt-12">
            {[
              ...
              },
              {
                ...
                a: "Use professional storage like SafeStorage. UAE law requires keeping business records for 5 years. Clean, secure document storage where you pay only for the space you use. Inventory storage available for e-commerce businesses.",
              },
              {
