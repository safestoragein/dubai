...
export const metadata: Metadata = {
  ...
  description: "Moving internationally from Dubai? Store your belongings affordably while you settle abroad. Avoid costly international shipping. From 12.6 AED / Sqft. Hassle-free pickup. Call +971505773388.",
  ...
  openGraph: {
    ...
    description: "Moving abroad from Dubai? Store instead of shipping — save thousands of dirhams and keep your options open. Hassle-free pickup, climate-controlled, from 12.6 AED / Sqft.",
      ...
      <div className="min-h-screen bg-white">
          ...
          <div className="container px-4 max-w-6xl mx-auto">
            ...
            <div className="bg-dubai-gold/10 border border-dubai-gold/30 rounded-xl p-6">
              <p className="text-dubai-navy font-medium">
                <strong>Storage comparison:</strong> Storage at SafeStorage Dubai (suitable for a 1-2 bedroom apartment) starts from 12.6 AED / Sqft (VAT-inclusive) — typically far less than the cheapest international shipping option for the same volume over a year. And with storage, you keep all your options open.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 bg-slate-50">
          <div className="container px-4 max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                { name: "Marcus & Helen T.", location: "JBR → Edinburgh", text: "Moving back to Scotland after 9 years in Dubai. Shipping quotes were AED 22,000 for our 3-bedroom villa contents. We stored with SafeStorage from 12.6 AED / Sqft instead. 14 months later we know exactly what we want to ship vs sell. Saved over AED 10,000 already and made much better decisions with time on our side.", rating: 5 },
