...
export const metadata: Metadata = {
  ...
  description: "Dubai's most trusted self storage facility offering secure units, 24/7 security, and door-to-door service. Call +971505773388 for instant quote.",
  ...
  return (
    <html lang="en" suppressHydrationWarning className={inter.variable}>
      ...
      <body className={inter.className}>
        ...
        {/* Meta Pixel Code (noscript) - lives in <body>; an <img> is not valid inside <head> */}
        <noscript>
          <img
            height="1"
            width="1"
            style={{ display: "none" }}
            src="https://www.facebook.com/tr?id=1103687542190576&ev=PageView&noscript=1"
            alt=""
          />
        </noscript>
