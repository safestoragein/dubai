...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safestorage.ae/locations/dubai/al-quoz",
    siteName: "SafeStorage Dubai",
    locale: "en_AE",
    type: "website",
  },
  alternates: {
    canonical: "https://safestorage.ae/locations/dubai/al-quoz",
    ...
    // sat at /locations/al-quoz while Arabic sat at
    // /ar/locations/dubai/al-quoz, so the two never resolved as alternates.
    languages: {
      "en-AE": "https://safestorage.ae/locations/dubai/al-quoz",
      "ar-AE": "https://safestorage.ae/ar/locations/dubai/al-quoz",
      "x-default": "https://safestorage.ae/locations/dubai/al-quoz",
    },
  },
}
...
const FAQS: { q: string; a: AnswerPart[] }[] = [
  ...
  },
  {
    ...
    a: [
      "For dead stock and archives, almost always. You're currently paying Al Quoz industrial rates for space holding things that don't move. You only pay for the volume you use. No setup fee, no annual commitment. Send us your volume and we'll put the two costs side by side so you can see it properly.",
    ],
  },
  {
  ...
  },
  {
    q: "What does it cost?",
    a: [
      "You pay for the space you use rather than a fixed unit size, so a few boxes costs a few boxes. Business Storage starts from 100 sq ft to 1,000+ sq ft. With zero setup fees and hidden charges; no lengthy contracts involved. Contact us at +971505773388 or fill out our ",
  ...
  },
  {
    ...
    a: [
      ...
      { text: "car storage", href: "/personal-storage-dubai/car-storage" },
      " for how to prepare one. If in doubt about something, check first — practically everything else goes. The full list is on our ",
      { text: "prohibited items page", href: "/self-storage-dubai/prohibited-items" },
      ".",
    ],
  },
]
...
const alQuozSchemas = [
  ...
  },
  {
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    '@id': 'https://safestorage.ae/locations/dubai/al-quoz#webpage',
...
export default function AlQuozPage() {
  return (
    ...
    <section className="py-16 bg-gray-50">
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        <div className="bg-white rounded-xl p-8 border border-gray-200 mb-8">
          ...
          <a href="/locations/dubai/dubai-marina" className="text-[#3E92CC] font-semibold hover:underline">
    ...
    <section className="py-16 bg-white">
      ...
      <AreaLinks emirate="dubai" area="al-quoz" />
    </>
  )
}
