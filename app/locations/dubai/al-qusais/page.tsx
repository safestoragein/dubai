...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://safestorage.ae/locations/dubai/al-qusais",
    ...
    // sat at /locations/al-qusais while Arabic sat at
    // /ar/locations/dubai/al-qusais, so the two never resolved as alternates.
    languages: {
      "en-AE": "https://safestorage.ae/locations/dubai/al-qusais",
      "ar-AE": "https://safestorage.ae/ar/locations/dubai/al-qusais",
      "x-default": "https://safestorage.ae/locations/dubai/al-qusais",
    },
  },
}
...
const alQusaisSchemas = [
  ...
  },
  {
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    '@id': 'https://safestorage.ae/locations/dubai/al-qusais#webpage',
      ...
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-10">
          ...
          <div>
            ...
            <p className="text-gray-700">
              ...
              <a href="/locations/dubai/mirdif" className="text-[#3E92CC] hover:underline">Mirdif service zone</a>.
            </p>
          </div>
        </div>
        ...
        <div className="bg-gray-50 rounded-xl p-8 mb-8">
          ...
          <p className="text-gray-700">
            ...
            sit close to our{" "}
            <a href="/locations/dubai/deira" className="text-[#3E92CC] hover:underline">Deira and Bur Dubai zone</a>, and
