...
export default function BusinessBayPage() {
  return (
    ...
    <section className="py-16 bg-gray-50">
      ...
      <AreaLinks emirate="dubai" area="business-bay" />
    </>
  )
}