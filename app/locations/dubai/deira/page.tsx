          ...
          <div className="grid md:grid-cols-2 gap-8 mb-10">
            <div>
              ...
              <p className="text-gray-700">
                ...
                specific items rather than pay for an entire storage unit. Starting from 12 AED / sqft,
