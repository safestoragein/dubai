...
export default function DeiraPage() {
  return (
    <>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <p className="text-lg text-gray-700 mb-6">
            ...
            storage. SafeStorage serves all of old Dubai with the same door-to-door pickup and flexible
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-10">
            <div>
              ...
              <p className="text-gray-700">
                ...
                specific items rather than pay for an entire storage unit. Residents
                can store just what they need and pay only for that — no wasted space, no fixed unit costs.
              </p>
            </div>
            <div>
      ...
      <AreaLinks emirate="dubai" area="deira" />
    </>
  )
}
