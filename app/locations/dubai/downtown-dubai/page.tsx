...
const downtownSchemas = [
...

  {
    ...
    hasOfferCatalog: {
      ...
      itemListElement: [
        { "@type": "Offer", name: "Storage", price: "12", priceCurrency: "AED", description: "Starts from 12 AED / sqft (VAT excluded)" },
      ],
    },
  },
  {
...
export default function DowntownDubaiPage() {
  return (
    <>
          ...
          <div className="bg-white rounded-xl p-8 border border-gray-200 mb-8">
            ...
            <div className="grid md:grid-cols-2 gap-6 text-gray-700">
              ...
              <div className="space-y-3">
                ...
                <p><strong>Transparent pricing, no surprises:</strong> Downtown residents pay the same rates as all Dubai customers — from 12 AED / sqft (VAT excluded). No location premiums, no high-rise access fees, no surprises at billing.</p>
              </div>
            </div>
          </div>
      ...
      <AreaLinks emirate="dubai" area="downtown-dubai" />
    </>
  )
}
