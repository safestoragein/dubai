      ...
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl p-6 border border-gray-200">
            ...
            <p className="text-gray-700">Commercial storage pricing for DIP and surrounding areas follows the same transparent volume-based model as all SafeStorage plans, starting from 12 AED / sqft (VAT excluded). For businesses, we also offer dedicated commercial units from 100 sq ft to 1,000+ sq ft. There are no setup fees, no long-term contracts required, and no hidden charges. Your dedicated commercial storage consultant will prepare a customised quote based on your specific volume, access requirements, and service frequency. Call +971505773388 or email us for a commercial quote.</p>
          </div>
          <div className="bg-white rounded-xl p-6 border border-gray-200">
