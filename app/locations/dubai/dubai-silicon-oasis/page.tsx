...
const dsoSchemas = [
...

  {
    ...
    description:
      "Secure storage for Dubai Silicon Oasis, Academic City, and International City residents and businesses. Door-to-Door pickup. Flexible plans from 12.65 AED / sqft.",
