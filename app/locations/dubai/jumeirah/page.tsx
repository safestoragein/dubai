...
const jumeirahSchemas = [
...

  {
    ...
    description: 'Expat-friendly storage in Jumeirah — keep belongings safely stored while you decide what to ship. Door-to-Door pickup, flexible terms, trusted by 500+ expats.',
  ...
  },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Jumeirah', item: 'https://safestorage.ae/locations/dubai/jumeirah' },
    ],
  },
]
...
export default function JumeirahPage() {
  return (
    ...
    <section className="py-16 bg-gray-50">
      ...
      <AreaLinks emirate="dubai" area="jumeirah" />
    </>
  )
}