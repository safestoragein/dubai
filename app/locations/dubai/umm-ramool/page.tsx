...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safestorage.ae/locations/dubai/umm-ramool",
    siteName: "SafeStorage Dubai",
    locale: "en_AE",
    type: "website",
  },
  alternates: {
    canonical: "https://safestorage.ae/locations/dubai/umm-ramool",
    ...
    // sat at /locations/umm-ramool while Arabic sat at
    // /ar/locations/dubai/umm-ramool, so the two never resolved as alternates.
    languages: {
      "en-AE": "https://safestorage.ae/locations/dubai/umm-ramool",
      "ar-AE": "https://safestorage.ae/ar/locations/dubai/umm-ramool",
      "x-default": "https://safestorage.ae/locations/dubai/umm-ramool",
    },
  },
}
...
const ummRamoolSchemas = [
  ...
  },
  {
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    '@id': 'https://safestorage.ae/locations/dubai/umm-ramool#webpage',
      ...
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-10">
          <div>
            ...
            <p className="text-gray-700">
              ...
              out in full on our{" "}
              <a href="/business-storage-dubai" className="text-[#3E92CC] hover:underline">business storage page</a>.
            </p>
          </div>
          <div>
        ...
        <div className="bg-gray-50 rounded-xl p-8 mb-8">
          ...
          <p className="text-gray-700">
            ...
            <a href="/locations/dubai/deira" className="text-[#3E92CC] hover:underline">Deira and Bur Dubai zone</a>, and Al
            Rashidiya through the{" "}
            <a href="/locations/dubai/mirdif" className="text-[#3E92CC] hover:underline">Mirdif zone</a> — both reach the
            same team.
          </p>
        </div>
      ...
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl p-6 border border-gray-200">
            ...
            <p className="text-gray-700">For anything that sits still, usually by a wide margin. Land beside the terminals commands a premium because of how fast goods move through it, and none of that speed benefits a pallet that has not shifted since March. Charging with us follows the volume you genuinely occupy, with nothing added for setup and no yearly commitment. Tell us roughly what you are holding and we will work out what it currently costs you in rent versus what it would cost here.</p>
          </div>
          <div className="bg-white rounded-xl p-6 border border-gray-200">
