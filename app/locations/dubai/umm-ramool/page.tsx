...
const ummRamoolSchemas = [
  ...
  },
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Umm Ramool', item: 'https://safestorage.ae/locations/dubai/umm-ramool' },
    ],
  },
]
