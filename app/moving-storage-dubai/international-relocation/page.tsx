...
export const metadata: Metadata = {
  ...
  description: "Moving internationally from Dubai? Store your belongings affordably while you settle abroad. Avoid costly international shipping. From 12 AED / sqft.",
  ...
  alternates: { canonical: "https://safestorage.ae/moving-storage-dubai/international-relocation" },
}
...
const schemas = [
  ...
  },
  {
    "@context": "https://schema.org",
    "@type": "WebPage",
    "@id": "https://safestorage.ae/moving-storage-dubai/international-relocation#webpage",
  ...
  },
  {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "International Relocation", item: "https://safestorage.ae/moving-storage-dubai/international-relocation" },
    ],
  },
]
  ...
  return (
    <>
      <SiloBreadcrumb
        trail={[
          { name: "Home", href: "/" },
          { name: "Moving & Storage Dubai", href: "/moving-storage-dubai" },
      ...
      <div className="min-h-screen bg-white">
          ...
          <div className="container px-4 max-w-6xl mx-auto">
            ...
            <div className="bg-dubai-gold/10 border border-dubai-gold/30 rounded-xl p-6">
              <p className="text-dubai-navy font-medium">
                <strong>Storage comparison:</strong> Storage at SafeStorage Dubai (suitable for a 1-2 bedroom apartment) starts from 12 AED / sqft (VAT excluded) — typically far less than the cheapest international shipping option for the same volume over a year. And with storage, you keep all your options open.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 bg-slate-50">
          <div className="container px-4 max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                { name: "Marcus & Helen T.", location: "JBR → Edinburgh", text: "Moving back to Scotland after 9 years in Dubai. Shipping quotes were AED 22,000 for our 3-bedroom villa contents. We stored with SafeStorage from 12 AED / sqft instead. 14 months later we know exactly what we want to ship vs sell. Saved over AED 10,000 already and made much better decisions with time on our side.", rating: 5 },
          ...
          <div className="container px-4 max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              ...
              <div className="mb-6">
                ...
                <p className="text-gray-700 leading-relaxed">The key factors in the store-vs-sell decision are replacement cost, shipping cost, sentimental value, and your confidence in the move being permanent. If a piece of furniture cost AED 5,000 and you can sell it for AED 2,000 but the cost of storing it for your timeline would exceed its resale value, selling is the rational choice — unless you are likely to return or the item has irreplaceable sentimental value. Conversely, for a high-value custom wardrobe that cost AED 15,000, storage at 12 AED / sqft (VAT excluded) is clearly preferable to selling at a heavy loss. The challenge is that most expats undersell furniture under time pressure, accepting 20–30% of original value. Our advice is always to calculate the storage cost for your realistic timeline first, then compare it honestly to the sale price you can actually achieve — not the original purchase price.</p>
              </div>
            </div>
          </div>
        </section>
      ...
      <SiloLinks path="/moving-storage-dubai/international-relocation" />
    </>
  )
}
