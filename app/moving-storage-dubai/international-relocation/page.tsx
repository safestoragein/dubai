          ...
          <div className="container px-4 max-w-6xl mx-auto">
            ...
            <div className="bg-dubai-gold/10 border border-dubai-gold/30 rounded-xl p-6">
              <p className="text-dubai-navy font-medium">
                <strong>Storage comparison:</strong> Storage at SafeStorage Dubai (suitable for a 1-2 bedroom apartment) starts from 12 AED / sqft — typically far less than the cheapest international shipping option for the same volume over a year. And with storage, you keep all your options open.
              </p>
            </div>
          </div>
        </section>
