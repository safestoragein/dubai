...
const sections = [
  ...
  },
  {
    ...
    storageConnection: "Moving between hotel and apartment? Store your belongings safely with us during the transition. Hassle-free pickup from anywhere in Dubai - focus on finding the right home, not managing boxes!",
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-gray-200">
              Join thousands who trusted SafeStorage during their relocation. Hassle-free pickup, flexible terms, and 24/7 security.
            </p>
