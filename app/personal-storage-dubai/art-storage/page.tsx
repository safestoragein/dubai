          ...
          <div className="container px-4 max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
              {[
                ...
                { q: "How much does art storage cost?", a: "Art storage at SafeStorage starts from 12 AED / sqft, based on the volume and type of items stored. A full collection requires an in-person consultation and quotation. Please call us at +971505773388 to discuss your specific requirements." },
              ].map((faq) => (
