...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safestorage.ae/personal-storage-dubai/art-storage",
    siteName: "SafeStorage Dubai",
    locale: "en_AE",
    type: "website",
  },
  alternates: { canonical: "https://safestorage.ae/personal-storage-dubai/art-storage" },
}
...
const schemas = [
  ...
  },
  {
    "@context": "https://schema.org",
    "@type": "WebPage",
    "@id": "https://safestorage.ae/personal-storage-dubai/art-storage#webpage",
  ...
  },
  {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Art Storage Dubai", item: "https://safestorage.ae/personal-storage-dubai/art-storage" },
    ],
  },
]
...
export default function ArtStoragePage() {
  return (
    <>
          ...
          <div className="container px-4 max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
              {[
                ...
                { q: "How much does art storage cost?", a: "Art storage at SafeStorage starts from 12 AED / sqft (VAT excluded), based on the volume and type of items stored. A full collection requires an in-person consultation and quotation. Please call us at +971505773388 to discuss your specific requirements." },
              ].map((faq) => (
      ...
      <SiloLinks path="/personal-storage-dubai/art-storage" />
    </>
  )
}
