      ...
      <div className="min-h-screen bg-white">
        ...
        <section className="py-16 bg-slate-50">
          <div className="container px-4 max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                { icon: Car, title: "Cars & SUVs", desc: "Sedans, SUVs, sports cars, family vehicles. From hatchbacks to Range Rovers.", price: "Priced by space used" },
                { icon: Bike, title: "Motorcycles & Scooters", desc: "All makes and models. Harley Davidson, Ducati, Yamaha, delivery scooters.", price: "Priced by space used" },
                ...
                { icon: Car, title: "Light Commercial Vehicles", desc: "Pickups, vans, and small trucks for businesses between contracts.", price: "Priced by space used" },
              ].map((v) => (
        ...
        <section className="py-16 bg-dubai-gold text-white text-center">
          <div className="container px-4 max-w-3xl mx-auto">
            ...
            <p className="text-xl text-white/90 mb-8">Get a free quote in 2 minutes. You pay only for the space your vehicle uses. No commitment required.</p>
