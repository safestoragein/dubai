...
const schemas = [
  ...
  },
  {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Expat Leaving UAE", item: "https://safestorage.ae/personal-storage-dubai/expat-storage" },
    ],
  },
]
          ...
          <div className="container px-4 max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-10">
              {[
                ...
                { title: "🏢 Store in Dubai", cost: "from 12.65 AED / sqft", timeframe: "Month-to-month flexibility", pros: ["Fraction of shipping cost", "Items ready if you return", "No customs hassle", "Clean, secure protection"], cons: ["Ongoing monthly cost"] },
              ].map((opt) => (
          ...
          <div className="container px-4 max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-dubai-navy text-white rounded-2xl p-8">
                ...
                <p className="text-white/70 text-sm mt-6">Pricing starts from 12.65 AED / sqft (VAT-inclusive). We offer a wide range of discounts on long-term and prepaid plans — contact us for the best available rate.</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="container px-4 max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              ...
              <div className="mb-6">
                ...
                <p className="text-gray-700 leading-relaxed">SafeStorage offers a wide range of prepaid discounts for expats who know they will be abroad for an extended period — the longer you prepay, the more you save off the standard rate. With pricing from 12.65 AED / sqft (VAT-inclusive), prepaying for a longer term is the most cost-effective option and eliminates the need for monthly transaction management. Contact us for the best available rate for your storage duration.</p>
              </div>
              <div className="mb-6">
