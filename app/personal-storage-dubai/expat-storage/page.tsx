          ...
          <div className="container px-4 max-w-6xl mx-auto">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
              {[
                ...
                { value: "12 AED", label: "Storage from / sqft" },
              ].map((s) => (
          ...
          <div className="container px-4 max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-10">
              {[
                ...
                { title: "🏢 Store in Dubai", cost: "from 12 AED / sqft", timeframe: "Month-to-month flexibility", pros: ["Fraction of shipping cost", "Items ready if you return", "No customs hassle", "Clean, secure protection"], cons: ["Ongoing monthly cost"] },
              ].map((opt) => (
        ...
        <section className="py-16 bg-slate-50">
          <div className="container px-4 max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                { name: "Emma T.", location: "Dubai Marina → London", text: "Moved back to London after 6 years in Dubai. Rather than shipping everything and paying AED 20,000, I stored my furniture with SafeStorage from 12 AED / sqft. When my assignment fell through 8 months later and I came back to Dubai, everything was there. Best decision I made.", rating: 5 },
