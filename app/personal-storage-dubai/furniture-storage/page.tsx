...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://safestorage.ae/personal-storage-dubai/furniture-storage" },
}
...
const schemas = [
  ...
  },
  {
    "@context": "https://schema.org",
    "@type": "WebPage",
    "@id": "https://safestorage.ae/personal-storage-dubai/furniture-storage#webpage",
...
export default function FurnitureStoragePage() {
  return (
    <>
          ...
          <div className="container px-4 max-w-6xl mx-auto">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
              {[
                ...
                { stat: "Free", label: "Itemised quote" },
        ...
        <section className="py-16 bg-white">
          <div className="container px-4 max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                { scenario: "Apartment Renovation", detail: "Renovating a 1-2BR apartment takes 4-12 weeks in Dubai. Storing furniture keeps it safe and gives contractors full access. A medium unit handles most 1-2BR contents." },
                ...
                { scenario: "Moving to New Country", detail: "International shipping furniture is expensive and risky. Store in Dubai first — most expats find they need different items abroad than they expected. Keep options open for 12 months." },
      ...
      <SiloLinks path="/personal-storage-dubai/furniture-storage" />
    </>
  )
}
