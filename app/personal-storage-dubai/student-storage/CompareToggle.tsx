...
/**
 * Phone toggle + scroll reveal for the "Storage vs keeping your room" cards.
...
export default function CompareToggle({ children }: { children: ReactNode }) {
  ...
  return (
    <>
      <div className={c.toggle} role="tablist" aria-label="Compare SafeStorage with keeping your room">
