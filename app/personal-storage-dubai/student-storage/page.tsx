...
export const metadata: Metadata = {
  ...
  description: "Cheap, safe student storage in Dubai. Store your belongings between semesters, summer holidays or graduation. From 12.65 AED / sqft.",
...
const schemas = [
  {
    ...
    description: "Affordable student storage in Dubai for semester breaks, summer holidays and graduation. Small units from 12.65 AED / sqft with door-to-door pickup near universities.",
