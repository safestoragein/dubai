...
export const metadata: Metadata = {
  ...
  description:
    "Transparent storage pricing in Dubai starting from AED 199/month. Various unit sizes with flexible plans. Hassle-free pickup & delivery included. Call +971505773388 for best rates.",
  keywords:
