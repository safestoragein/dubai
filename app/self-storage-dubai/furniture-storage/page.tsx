...
export const metadata: Metadata = {
  ...
  description: "Dubai's most affordable furniture storage starting from AED 150/month. Climate-controlled units protect sofas, beds & dining sets from heat damage. Free pickup available. 24/7 access, CCTV security.",
  ...
  openGraph: {
    ...
    description: "Store furniture safely in Dubai with 24/7 access, climate control, and professional handling. Free pickup & delivery available.",
            ...
            <div className="overflow-x-auto">
              <table className="w-full border-collapse">
                ...
                <tbody>
                  ...
                  <tr>
                    <td className="border p-4 font-semibold">Free Pickup Service</td>
                    <td className="border p-4 text-center bg-dubai-gold/10">
                      <CheckCircle2 className="h-6 w-6 text-green-600 mx-auto" />
                    </td>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <Card>
                <CardContent className="pt-6">
                  ...
                  <p className="text-gray-600 mb-4 italic">
                    "Best prices in Dubai! Saved over 40% compared to other storage companies. Free pickup was a huge bonus. Highly recommend for furniture storage."
                  </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-lg">Do you provide free pickup and delivery for furniture?</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-600">
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-gray-600">
                    ...
                    <strong>Full Service (Most Popular):</strong> We handle everything - professional packing, free pickup, transport, storage, and scheduled return delivery. Perfect for busy professionals or those without transport.<br/><br/>
