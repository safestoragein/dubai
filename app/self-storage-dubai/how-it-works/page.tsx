      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="space-y-8 mb-12">
            ...
            <div className="bg-white rounded-xl p-8 shadow-sm">
              <h3 className="text-xl font-bold text-[#0A2463] mb-4">Step 4 — Secure Climate-Controlled Storage in Our Facility</h3>
              <p className="text-gray-700 leading-relaxed mb-4">
                Once collected, your items are transported directly to SafeStorage Dubai&apos;s secure warehouse facility located in Dubai Investment Park. The entire facility is climate-controlled to maintain a consistent temperature of 20&ndash;22&deg;C year-round, regardless of the outdoor temperature. All items are stored off the floor on clean pallets or raised platforms to maintain air circulation and prevent moisture contact from the ground. Items are arranged to allow air to flow freely between pieces, preventing heat pockets or condensation build-up. The facility undergoes daily pest control treatments and weekly deep cleaning.
              </p>
              <p className="text-gray-700 leading-relaxed">
          ...
          <div className="space-y-5">
            {[
              ...
              { q: "How is pricing calculated — by unit size or by item?", a: "SafeStorage Dubai prices storage based on the volume and type of items stored, not a fixed unit size. This means you only pay for the space your items actually occupy, rather than paying for an empty unit you may not fill completely. When you get a quote, the price is based on an assessment of your inventory. This model typically works out cheaper than self-storage for most customers, as self-storage units are often larger than needed and customers pay for unused space. Long-term discounts of up to 20% are available for 6–12 month prepaid plans." },
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            <div>
              ...
              <p className="text-gray-700">
                ...
                unit size, and the hassle-free pickup and delivery is included in the monthly rate. For self-service,
