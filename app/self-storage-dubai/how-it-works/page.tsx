          ...
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            <div>
              ...
              <p className="text-gray-700">
                ...
                unit size, and door-to-door pickup & delivery is available. For self-service,
