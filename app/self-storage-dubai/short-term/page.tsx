          ...
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-3xl">
              ...
              <p className="mb-4 text-lg text-white/90">
                ...
                it to the new address when you&rsquo;re ready. You pay only for{" "}
                <strong className="text-dubai-gold">the space your items use</strong>, as part of the wider{" "}
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-3xl">
              ...
              <p className="mb-4 text-gray-700">
                Billed monthly on the space your goods use, with a two-week minimum booking and no hidden fees.
              </p>
              <p className="mb-4 text-gray-700">
