    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <section className="py-16 bg-white">
        <div className="container px-4 max-w-4xl mx-auto">
          ...
          <p className="text-gray-700 leading-relaxed mb-6">The economics of student storage make a compelling case. A student paying AED 2,000–3,000 per month for accommodation faces a choice at semester end: maintain the lease through the break (costing AED 6,000–9,000 for a 3-month summer), ship belongings home (expensive and impractical for most items), leave belongings with friends (risky and inconvenient for all parties), or store with SafeStorage starting from 12.6 AED / Sqft (VAT-inclusive). The storage option saves most students AED 5,000–8,000 per academic year — enough to fund meaningful travel, academic materials, or simply reduce the overall cost of studying in Dubai. For international students whose home countries are far from the UAE, storage is often the only genuinely practical option.</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            <div>
              ...
              <p className="text-gray-700 mb-3">
                ...
                starting from 12.6 AED / Sqft (VAT-inclusive) for a small unit that holds a student room&apos;s worth of belongings.
              </p>
          ...
          <div className="bg-white rounded-xl p-6 border border-gray-200">
            ...
            <p className="text-gray-700">
              Student storage plans start from 12.6 AED / Sqft (VAT-inclusive) with hassle-free pickup and delivery. We offer special
