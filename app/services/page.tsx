        ...
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl p-6 border border-gray-200">
              ...
              <p className="text-gray-700">Door-to-door pickup from your Dubai address is available — our team handles collection and return so you never need to hire a van or do any heavy lifting, in any area of Dubai. We also cover Sharjah, Ajman and Abu Dhabi. All fees are explained in your quote before you confirm, so there are never any surprise charges.</p>
            </div>
            <div className="bg-white rounded-xl p-6 border border-gray-200">
