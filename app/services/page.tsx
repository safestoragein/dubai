...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "Complete storage solutions in Dubai. Climate-controlled units, 24/7 security, free pickup. Call +971505773388.",
  ...
  twitter: {
    ...
    description: "Personal, business & vehicle storage solutions with free pickup & delivery.",
