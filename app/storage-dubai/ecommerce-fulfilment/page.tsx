      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <div className="bg-gray-50 rounded-xl p-8 mb-10">
            ...
            <p className="text-gray-700">
              Storage costs for e-commerce sellers depend on the volume of inventory held. Small sellers (fewer than 500 SKUs, low-volume orders) typically pay AED 599–999/month for a medium storage unit. High-volume sellers with extensive SKU catalogues and multiple daily orders are priced on a custom basis. All pricing is fixed monthly — no per-pick charges or variable rates that make cost forecasting difficult. Contact our team at +971505773388 for a quote based on your specific product mix and order volume.
            </p>
          </div>
        </div>
      </section>
