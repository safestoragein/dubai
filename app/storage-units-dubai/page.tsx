...
const testimonials = [
  ...
  },
  {
    ...
    rating: 5,
    text: "Moved from 3BR to 1BR apartment. Instead of selling furniture, I stored it. The door-to-door pickup saved me so much time - they literally did everything!",
    highlight: "Door-to-Door pickup",
  },
  {
    name: "James Wilson",
...
const faqs = [
  ...
  },
  {
    ...
    answer: "Standard access hours are Monday–Sunday 8AM–8PM. Business customers can arrange extended hours or 24/7 access packages based on their needs. You can also request Doorstep delivery of your items to your location at any time.",
  },
  {
  ...
  },
  {
    ...
    answer: "Our main facility is in Dubai Investment Park 2, strategically located with easy access from all Dubai areas. But location doesn't matter much - we provide door-to-door pickup from YOUR location (Dubai Marina, Business Bay, JLT, Downtown, wherever you are) and delivery back!",
  },
  {
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-3 mb-8">
              ...
              <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full">
                ...
                <span className="text-white text-sm font-medium">Door-to-door Pickup</span>
              </div>
              <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full">
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <div className="space-y-5">
            {[
              { q: "Do storage units in Dubai include door-to-door service?", a: "Yes. SafeStorage Dubai offers door-to-door pickup & delivery across Dubai. Our professional team collects your items from your home, office, or any Dubai location, transports them to our secure facility, and delivers them back whenever you need them. This saves customers the hassle of hiring a lorry or arranging separate movers themselves." },
