...
export const metadata: Metadata = {
  ...
  description: "Cheap, safe student storage in Dubai. Store your belongings between semesters, summer holidays or graduation. From AED 99/month. Hassle-free pickup near major universities. Call +971505773388.",
  ...
  openGraph: {
    ...
    description: "Student storage in Dubai from AED 99/month. Store between semesters, summer breaks or after graduation. Hassle-free pickup near major universities.",
...
const schemas = [
  {
    ...
    description: "Affordable student storage in Dubai for semester breaks, summer holidays and graduation. Small units from AED 99/month with hassle-free pickup near universities.",
          ...
          <div className="container px-4 max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="mb-6">
                ...
                <p className="text-gray-700 leading-relaxed">Student storage at SafeStorage Dubai starts from AED 99 per month for a locker or mini unit, which holds 10–15 boxes, suitcases, bags, and bedding. A small unit at AED 199–299 per month accommodates a full student room including a single bed, desk, chair, wardrobe, and 20–30 boxes of personal belongings. This is the most popular option for students storing between semesters. For students sharing a larger apartment or storing a bicycle and additional equipment, a medium unit at AED 499–699 per month provides more space. All prices include climate control, 24/7 security, and hassle-free pickup from your accommodation. There are no hidden charges and no long-term contracts required.</p>
              </div>
              <div className="mb-6">
