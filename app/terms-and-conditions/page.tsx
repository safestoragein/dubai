    ...
    <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '40px 20px', fontFamily: 'system-ui, -apple-system, sans-serif', lineHeight: '1.8', color: '#1a1a1a' }}>
      ...
      <section style={{ marginBottom: '40px' }}>
        ...
        <ol style={{ paddingLeft: '20px' }}>
          ...
          <li style={{ marginBottom: '15px', fontSize: '16px' }}>If the Customer fails to make any payment within SIX (6) days of billing, late charges will apply at the rate of 2% per month on the unpaid amount.</li>
          <li style={{ marginBottom: '15px', fontSize: '16px' }}>
