...
const structuredData = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      numberOfItems: 10,
      itemListElement: [
        { "@type": "ListItem", position: 1, name: "SafeStorage Dubai", description: "Dubai's #1 rated storage company. Valet storage with door-to-door pickup & delivery, clean secure units, 24/7 security, and free insurance. From 12.60 AED / sqft.", url: "https://safestorage.ae" },
...
const companies = [
  {
    ...
    highlights: [
      "Door-to-Door pickup & delivery across all Dubai areas",
