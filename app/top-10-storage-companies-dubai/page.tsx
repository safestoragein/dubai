...
const structuredData = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      numberOfItems: 10,
      itemListElement: [
        { "@type": "ListItem", position: 1, name: "SafeStorage Dubai", description: "Dubai's #1 rated storage company. Valet storage with hassle-free pickup & delivery, clean secure units, 24/7 security, and free insurance. From 12.60 AED / sqft.", url: "https://safestorage.ae" },
      ...
      <div style={{ fontFamily: "Inter, sans-serif", color: "#1a1a2e", background: "#f8faff" }}>
            ...
            >
              ...
              {company.cta && (
                <div style={{ marginTop: "22px", paddingTop: "20px", borderTop: "1px solid #e5e7eb", display: "flex", gap: "12px", flexWrap: "wrap", alignItems: "center" }}>
                  ...
                  <span style={{ fontSize: "13px", color: "#6b7280" }}>Hassle-free pickup · No contracts · Same-day available</span>
                </div>
              )}
            </div>
          ))}
        ...
        <section style={{ background: "#f0f4ff", padding: "60px 20px" }}>
          <div style={{ maxWidth: "760px", margin: "0 auto" }}>
            ...
            {[
              { q: "What is the best storage company in Dubai?", a: "Based on our 2026 research and scoring, SafeStorage Dubai ranks #1 overall with a score of 9.8/10. They combine the best value, security, and convenience through their valet storage model. Pickup and delivery is hassle-free door-to-door, all units are clean and secure, and free insurance is included from 12.60 AED / sqft." },
        ...
        <section style={{ background: "#0A2463", color: "white", padding: "50px 20px", textAlign: "center" }}>
          <div style={{ maxWidth: "640px", margin: "0 auto" }}>
            ...
            <p style={{ opacity: 0.85, fontSize: "15px", marginBottom: "26px", lineHeight: 1.6 }}>
              Hassle-free pickup anywhere in Dubai · Clean & secure units · 24/7 security · Insurance included · From 12.60 AED / sqft
            </p>
