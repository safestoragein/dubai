...
const structuredData = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      numberOfItems: 10,
      itemListElement: [
        { "@type": "ListItem", position: 1, name: "SafeStorage UAE", description: "UAE's #1 rated storage company. Clean, secure valet storage with hassle-free pickup & delivery, 24/7 security, and free insurance. From 12.60 AED / sqft.", url: "https://safestorage.ae" },
    ...
    },
    {
      "@type": "FAQPage",
      mainEntity: [
        { "@type": "Question", name: "What is the best storage company in UAE?", acceptedAnswer: { "@type": "Answer", text: "SafeStorage UAE is rated the #1 storage company in the UAE in 2026 with a score of 9.8/10. They offer clean, secure valet storage from 12.60 AED / sqft with hassle-free pickup and delivery across all emirates, 24/7 security, and free insurance up to AED 5,000." } },
        ...
        <section style={{ background: "#f0f4ff", padding: "60px 20px" }}>
          <div style={{ maxWidth: "760px", margin: "0 auto" }}>
            ...
            {[
              ...
              { q: "Which is the most affordable storage in UAE?", a: "SafeStorage UAE offers the best value from 12.60 AED / sqft — with clean, secure storage, hassle-free pickup and delivery, security, and insurance all included. If you compare the true all-in cost (adding surcharges, insurance, and van rental for delivery), SafeStorage consistently comes out as the most affordable option." },
        ...
        <section style={{ background: "#0A2463", color: "white", padding: "50px 20px", textAlign: "center" }}>
          <div style={{ maxWidth: "640px", margin: "0 auto" }}>
            ...
            <p style={{ opacity: 0.85, fontSize: "15px", marginBottom: "26px", lineHeight: 1.6 }}>
              Hassle-free pickup anywhere in UAE · Clean & secure units · 24/7 security · Insurance included · From 12.60 AED / sqft
            </p>
