export const contactFaqs = [
  {
    ...
    answer:
      "Our customer support team is available from 8 AM to 10 PM, seven days a week. Our storage facilities are accessible 24/7 for customers with active storage plans.",
  },
  {
    question: "Do you offer live chat support?",
    answer:
      "Yes, we offer live chat support during our business hours (8 AM to 10 PM). You can also reach us via WhatsApp for quick responses to your queries.",
  },
  {
