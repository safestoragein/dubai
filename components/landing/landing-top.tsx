 ...
 * ------------------------------------------------------------------ */
/** The home hero: the owner's drawn Dubai skyline is back (owner, 2026-09-22),
 *  with the page's own copy over it — headline, slogan, paragraph, both buttons
 *  and the rating card are live text again. */
const HERO_IMAGE = "/landing/hero-dubai-skyline.jpg"
  ...
  return (
    <section className={`${s.hero} ${s.heroBleed}`}>
      <div
        ...
        style={{ ["--hero-img" as string]: `url("${HERO_IMAGE}")` } as CSSProperties}
      >
