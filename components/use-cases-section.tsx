...
const useCases = [
  {
    ...
    cta: "/self-storage-dubai/short-term",
  ...
  },
  {
    ...
    cta: "/business-storage-dubai/ecommerce-fulfilment",
  ...
  },
  {
    ...
    cta: "/personal-storage-dubai/student-storage",
  ...
  },
  {
    ...
    cta: "/personal-storage-dubai/car-storage",
    ...
    <section className="w-full py-20 bg-gradient-to-b from-gray-50 to-white">
      <div className="container px-4 md:px-6">
        ...
        <div className="text-center mt-12">
          ...
          <p className="text-gray-400 text-sm mt-3">Door-to-Door pickup anywhere in Dubai · No long-term contract</p>
        </div>
      </div>
    </section>
  )
