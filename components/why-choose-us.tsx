...
export default function WhyChooseUs() {
  const features = [
    ...
    },
    {
      ...
      description:
        "What we quote is what you pay. No admin fees, no deposit surprises, no hidden charges on your invoice. VAT excluded pricing from 12 AED / sqft. We also offer a price-match guarantee — show us a lower quoted price and we'll beat it.",
