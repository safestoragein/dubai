...
export const ABU_DHABI: EmirateDef = {
  ...
  hub: {
    ...
    description:
      "Self storage in Abu Dhabi, charged only on the space your items use. We collect from your address across ten districts, wrap and load, and store at our nearest facility.",
    keywords:
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Storage is charged on the floor space your goods actually occupy — the same rate as everywhere else we operate. Transport is quoted separately on your address and how the access works.",
      },
      {
