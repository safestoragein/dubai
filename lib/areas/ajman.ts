...
export const AJMAN: EmirateDef = {
  ...
  hub: {
    ...
    description:
      "Self storage in Ajman, charged only on the space your items use. We operate a warehouse in the emirate, collect from your address across twelve districts, and store locally.",
    keywords:
    ...
    intro: [
      ...
      "We run it the other way round. Tell us roughly what you have, we come to your Ajman address, wrap and load, and store it at our facility in the emirate. Storage is charged on the floor space your things actually occupy — and when you want any of it back, we bring it to you.",
    ],
    faqs: [
      {
