  ...
  hub: {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "The storage rate does not — it is AED 12 per sq ft per month, VAT excluded, everywhere. Transport is quoted on your address and how the access works, so a ninth-floor flat with a shared service lift and a ground-floor villa with parking are priced differently even on the same street.",
      },
    ],
  },
