...
const priceFaq = {
  ...
  a: "Storage is charged on the floor space your goods actually occupy — the same rate everywhere we operate. Transport is quoted separately on your address and how the access works, and both numbers are agreed before anything is booked.",
}
...
export const RAS_AL_KHAIMAH: EmirateDef = {
  ...
  hub: {
    ...
    description:
      "Self storage for Ras Al Khaimah. We collect from your address across RAK, wrap and load, and store at our nearest facility. You pay only for the space your items use.",
    keywords:
...
export const FUJAIRAH: EmirateDef = {
  ...
  hub: {
    ...
    description:
      "Self storage for Fujairah and the east coast. We collect from your address, wrap and load, and store at our nearest facility. You pay only for the space your items use.",
    keywords:
...
export const UMM_AL_QUWAIN: EmirateDef = {
  ...
  hub: {
    ...
    description:
      "Self storage for Umm Al Quwain. We collect from your address, wrap and load, and store at our nearest facility. You pay only for the space your items use.",
    keywords:
...
export const AL_AIN: EmirateDef = {
  ...
  hub: {
    ...
    description:
      "Self storage for Al Ain. We collect from your address across the city, wrap and load, and store at our nearest facility. You pay only for the space your items use.",
    keywords:
