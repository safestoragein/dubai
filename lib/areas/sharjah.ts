...
export const SHARJAH: EmirateDef = {
  ...
  hub: {
    ...
    description:
      "Self storage in Sharjah, charged only on the space your items use. We operate a warehouse in the emirate, collect from fifteen districts, and store locally.",
    keywords:
    ...
    intro: [
      ...
      "We work the other way round. Tell us roughly what you have, we come to your Sharjah address, wrap and load, and store at our facility in the emirate. Storage is calculated on the space your things actually occupy, with no hidden fees.",
    ],
    faqs: [
      {
