    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"><tr>
      <td class="stack" width="50%" valign="top" style="padding-right:8px;">
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background:${NAVY};border-radius:12px;font-family:${F};"><tr><td style="padding:22px 22px 20px;">
          ...
          <div style="font-size:12px;line-height:1.5;color:${CARD_MUTED};border-top:1px solid ${NAVY_LINE};margin-top:12px;padding-top:12px;">Estimated ${d.totalSqft} sq ft at AED 12 / sq ft &middot; VAT excluded. Billed monthly, cancel anytime.</div>
        </td></tr></table>
      </td>
...
Estimated ${d.totalSqft} sq ft at AED 12 per sq ft, VAT excluded. Billed monthly, cancel anytime.
