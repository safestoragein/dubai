...
export const SILO2_PAGES: SiloPageContent[] = [
  /* ------------------------------------------------------ household-storage */
  {
    ...
    description:
      "Household storage in Dubai, billed on the space you use. We empty the property, wrap and load everything, and deliver it to the next address when you are ready.",
    keywords:
    ...
    hero: [
      ...
      "You pay only for **the floor space your goods occupy**. A one-bedroom is typically 60–90 sq ft, a two-bedroom 120–150, a three-bedroom villa 240–270.",
    ],
    sections: [
      {
        kind: "prose",
  ...
  /* ------------------------------------------------------ apartment-storage */
  {
    ...
    description:
      "Storage for Dubai apartments. We handle the service-lift booking and the building's moving window, wrap in the flat and carry everything down. Pay only for the space you use.",
    keywords:
    ...
    hero: [
      ...
      "Storage is billed **on measured space**, so you pay only for what your items use. A studio is around 30 sq ft, a one-bedroom 60–90, a two-bedroom 120–150.",
    ],
    sections: [
      {
        kind: "prose",
  ...
  /* ---------------------------------------------------------- villa-storage */
  {
    ...
    hero: [
      ...
      "A three-bedroom villa's contents typically occupy **240–270 sq ft** in storage, and four bedrooms and above is quoted on survey. **Space used is the whole of the monthly figure**, so you pay only for what your goods occupy.",
  ...
  /* -------------------------------------------------------- luggage-storage */
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "It is billed on the space the bags occupy, which for a handful of suitcases is a small monthly figure. Transport is quoted separately on the addresses involved.",
      },
      {
  ...
  /* ------------------------------------------------------- seasonal-storage */
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "It is billed on the space used, so you pay only for what the kit occupies. A camping set, a barbecue and six cartons is typically 15 to 25 square feet.",
      },
      {
  ...
  /* ----------------------------------------------- sports-equipment-storage */
  {
    ...
    hero: [
      ...
      "It is all bulky and low value per cubic foot, which makes it exactly the wrong thing to keep in a Dubai flat and exactly the right thing to store, **paying only for the space it uses**.",
    ],
    sections: [
      {
        kind: "cards",
  ...
  /* ------------------------------------------------------ wardrobe-storage */
  {
    ...
    hero: [
      ...
      "A full wardrobe's contents is typically 10 to 20 square feet once boxed, which, **billed on space used**, is a very small monthly figure against the cost of replacing a wardrobe.",
    ],
    sections: [
      {
        kind: "prose",
