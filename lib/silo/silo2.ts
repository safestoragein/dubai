...
export const SILO2_PAGES: SiloPageContent[] = [
  /* ------------------------------------------------------ household-storage */
  {
    ...
    description:
      "Household storage in Dubai from AED 12 per sq ft per month. We empty the property, wrap and load everything, and deliver it to the next address when you are ready.",
    keywords:
  ...
  /* ------------------------------------------------------ apartment-storage */
  {
    ...
    description:
      "Storage for Dubai apartments. We handle the service-lift booking and the building's moving window, wrap in the flat and carry everything down. From AED 12 per sq ft.",
    keywords:
  ...
  /* ------------------------------------------------------ wardrobe-storage */
  {
    ...
    hero: [
      ...
      "A full wardrobe's contents is typically 10 to 20 square feet once boxed, which at **AED 12 per sq ft per month** is a very small monthly figure against the cost of replacing a wardrobe.",
    ],
    sections: [
      {
        kind: "prose",
