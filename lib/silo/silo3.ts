  ...
  /* -------------------------------------------------- retail-stock-storage */
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Compare AED 12 per sq ft per month against your rent plus service charge per square foot. For most Dubai retail locations it is not a close comparison, and the better the location the wider the gap.",
      },
      {
