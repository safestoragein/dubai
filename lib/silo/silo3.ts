...
export const SILO3_PAGES: SiloPageContent[] = [
  ...
  /* ------------------------------------------------------- archive-storage */
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "It is billed on the space used. Four hundred boxes is roughly 160 square feet. For volumes above that we would rather survey and review the index than quote from a box count.",
      },
      {
  ...
  /* -------------------------------------------------- retail-stock-storage */
  {
    ...
    hero: [
      ...
      "Storage is **billed only on the space your stock uses** — worth putting directly next to your rent per square foot, because the comparison is usually not close.",
    ],
    sections: [
      {
        kind: "prose",
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Get a free, itemised storage quote and compare it against your rent plus service charge per square foot. For most Dubai retail locations it is not a close comparison, and the better the location the wider the gap.",
      },
      {
  ...
  /* ----------------------------------------------------- equipment-storage */
  {
    ...
    hero: [
      ...
      "Everything else — hand tools, corded power tools, scaffolding, staging, cabling, test equipment, catering kit — stores straightforwardly, indoors and racked, **billed only on the space it uses**.",
    ],
    sections: [
      {
        kind: "prose",
